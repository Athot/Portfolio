      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            <span className="text-primary">Thotshang</span>
          ...
          <div className="mt-8 flex gap-4">
            <a
              href="/resume.pdf"
              className="bg-primary text-black px-6 py-3 rounded-md font-semibold hover:bg-pink-400 transition"
            >
              Download Resume
            </a>
            ...
            <a
              href="#contact"
              className="border-2 border-primary text-primary px-6 py-3 rounded-md font-semibold hover:bg-primary hover:text-black transition"
            >
              Contact Me
            </a>
          </div>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full border-4 border-pink-500 overflow-hidden">
            {/* Accent bottom shape */}
            <div className="absolute bottom-0 left-0 w-full h-1/4 bg-pink-500 z-0" />
